...
REF_OUTPUT_CURVES_PATH = str(
    Path(__file__).parent
    / "dynawo/benchmark_data/ieee14/ieee14_GeneratorDisconnections/ref_output_curves.csv",
)
...
def _make_config(tmp_dir: str, dataset) -> NestedNamespace:
    ...
    return NestedNamespace(
        ...
        # would silently *enable* solver logging (same for include_dc_res,
        # pf_fast, dcpf_fast).
