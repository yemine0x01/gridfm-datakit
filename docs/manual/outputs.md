...
layout and keyed by `(scenario_index, perturbation_index, event_index)` instead
of `scenario` / `load_scenario_idx`. See [Dynamic Simulation](dynamic_simulation.md#outputs).
